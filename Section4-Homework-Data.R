...
myplot_param_default(Free_Throws)  #using the default rows
myplot_param_default(Free_Throws_Attempts) 
myplot_param_default(Free_Throws/Free_Throws_Attempts)  #accuracy
myplot_param_default(Free_Throws_Attempts/Games) 
myplot_param_default(FieldGoals/FieldGoalAttempts)

# - player style patterns excluding free throws

Points-Free_Throws

myplot_param_default((Points-Free_Throws)/FieldGoals)
